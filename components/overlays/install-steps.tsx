...
// taps a player makes in Safari. Isolated in its own file because it describes
// someone else's UI, and someone else's UI changes.
export function InstallSteps() {
  return (
    <View className="mt-4 gap-2">
      <InstallStep step={1} label="Tap Share in the toolbar">
