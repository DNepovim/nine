...
export const TIPS = [
  msg`Set the coarse 9× / 6× buttons first to get near the target, then fine-tune with the 1× / 2× buttons.`,
  ...
  msg`Come back to Trainee once you have been scoring a while. It is the only place to take a route apart with no run riding on it.`,
